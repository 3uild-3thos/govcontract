...
Flags override config file values, which override environment variables.
...
- The CLI merges sources in this order: explicit flags > config file > environment variables > built-in defaults.
