...
pub const DEFAULT_OPERATOR_API_URL: &str = "https://api.solgov.online/";
...
pub const SVMGOV_OFFLINE_ENV: &str = "SVMGOV_OFFLINE";

// Mock program ID for local testing (replaces gov-v1 program)
pub const MOCK_SNAPSHOT_PROGRAM_ID: &str = "65smeZTDVuVRQZ1zdUF8wXRMDXhAMVTxRbV3n3MyXLPJ";
