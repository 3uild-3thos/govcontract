...
// Example wallet interface (from @solana/wallet-adapter-react)
 ...
 */
export async function exampleCreateProposal(wallet: WalletAdapter): Promise<string | null> {
  console.log("Creating new proposal...");
  
  const result = await createProposal({
    title: "Increase Validator Commission Cap",
    description: "Proposal to increase the maximum validator commission from 10% to 15%. See: https://github.com/solana-labs/solana/issues/12345",
 ...
 */
export async function exampleCompleteWorkflow(wallet: WalletAdapter): Promise<void> {
