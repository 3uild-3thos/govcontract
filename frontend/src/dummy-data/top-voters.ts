...
export const topVoters: TopVoterRecord[] = [
  {
    ...
    stakedLamports: 1_200_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 6.81,
    voteTimestamp: "2023-11-15T14:23:00Z",
    voteData: {
      forVotesLamports: 1_200_000 * LAMPORTS_PER_SOL,
  ...
  },
  {
    ...
    stakedLamports: 987_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 5.23,
    voteTimestamp: "2023-11-14T09:10:00Z",
    voteData: {
      forVotesLamports: 987_000 * LAMPORTS_PER_SOL,
      againstVotesLamports: 0,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 765_000 * LAMPORTS_PER_SOL,
    voteOutcome: "against",
    votePercentage: 4.05,
    voteTimestamp: "2023-11-13T18:45:00Z",
    voteData: {
      forVotesLamports: 0,
      againstVotesLamports: 765_000 * LAMPORTS_PER_SOL,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 543_000 * LAMPORTS_PER_SOL,
    voteOutcome: "abstain",
    votePercentage: 2.88,
    ...
    voteData: {
      forVotesLamports: 0,
      againstVotesLamports: 0,
      abstainVotesLamports: 543_000 * LAMPORTS_PER_SOL,
    },
  ...
  },
  {
    ...
    stakedLamports: 1_450_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 7.96,
    voteTimestamp: "2023-11-15T03:40:00Z",
    voteData: {
      forVotesLamports: 1_450_000 * LAMPORTS_PER_SOL,
      againstVotesLamports: 0,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 1_015_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 6.12,
    voteTimestamp: "2023-11-14T21:05:00Z",
    voteData: {
      forVotesLamports: 1_015_000 * LAMPORTS_PER_SOL,
      againstVotesLamports: 0,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 812_000 * LAMPORTS_PER_SOL,
    voteOutcome: "against",
    votePercentage: 4.61,
    voteTimestamp: "2023-11-13T11:30:00Z",
    voteData: {
      forVotesLamports: 0,
      againstVotesLamports: 812_000 * LAMPORTS_PER_SOL,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 1_110_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 6.71,
    voteTimestamp: "2023-11-15T05:50:00Z",
    voteData: {
      forVotesLamports: 1_110_000 * LAMPORTS_PER_SOL,
      againstVotesLamports: 0,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 698_000 * LAMPORTS_PER_SOL,
    voteOutcome: "abstain",
    votePercentage: 3.28,
    ...
    voteData: {
      forVotesLamports: 0,
      againstVotesLamports: 0,
      abstainVotesLamports: 698_000 * LAMPORTS_PER_SOL,
    },
  ...
  },
  {
    ...
    stakedLamports: 1_980_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 10.45,
    voteTimestamp: "2023-11-15T01:25:00Z",
    voteData: {
      forVotesLamports: 1_980_000 * LAMPORTS_PER_SOL,
      againstVotesLamports: 0,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 605_000 * LAMPORTS_PER_SOL,
    voteOutcome: "for",
    votePercentage: 3.96,
    voteTimestamp: "2023-11-14T16:40:00Z",
    voteData: {
      forVotesLamports: 605_000 * LAMPORTS_PER_SOL,
      againstVotesLamports: 0,
      abstainVotesLamports: 0,
    },
  ...
  },
  {
    ...
    stakedLamports: 889_000 * LAMPORTS_PER_SOL,
    voteOutcome: "against",
    votePercentage: 5.02,
    voteTimestamp: "2023-11-13T08:20:00Z",
    voteData: {
      forVotesLamports: 0,
      againstVotesLamports: 889_000 * LAMPORTS_PER_SOL,
      abstainVotesLamports: 0,
    },
